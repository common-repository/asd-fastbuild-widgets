<?php
/**
 * Defines the ASD_PhoneWidget class
 *
 * @package     WordPress
...
/** ----------------------------------------------------------------------------
 *   class ASD_PhoneWidget
 *   displays phone information from Site Data admin panel options
 *  ------------------------------------------------------------------------- */
class ASD_PhoneWidget extends ASD_Widget {
	...
	public function __construct() {
		parent::__construct( false, 'ASD Phone Widget' );
	}
	...
	public function widget( $args, $instance ) {
		...
		echo '<div class="asd-widget asd-phonewidget">' . "\r\n";

		$this->print_item( 'asd_fastbuild_phone1', '', 'true' );
		$this->print_item( 'asd_fastbuild_phone2', '', 'true' );
